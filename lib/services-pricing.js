...
// pick one, that's your single recurring line. Section is presented to
// customers under the "Hosting & Analytics" heading. Beacon tiers come from
// lib/tier-limits.js (TIER_PRICING); Apex bundles a website-exclusive
// "Beacon Lite" budget on top of everything in Orbit.
const LADDER = {
  launch: {
    name: 'Launch',
    monthly: 25,
    tagline: 'The floor — get online and tracked',
    features: [
      'Site hosting + CDN',
      'Uptime monitoring',
      'Visitor analytics + lead tracking',
  ...
  orbit: {
    name: 'Orbit',
    monthly: 59,
    tagline: 'Get found and capture leads — automated',
    features: [
      'Everything in Launch',
      'Google-readable business data (LocalBusiness schema → rich results)',
      'Automatic Google review refresh on your site',
      'SEO blog generation — one-click, on demand',
      'Page speed + image SEO upkeep',
  ...
  apex: {
    name: 'Apex',
    monthly: 99,
    tagline: 'Full marketing engine — includes Beacon Lite',
    features: [
      'Everything in Orbit',
      'Beacon Lite included — AI marketing engine, website customers only',
      'Unlimited SEO blog generation via your Beacon budget',
    ],
    // NOTE: "Beacon Lite" is a website-exclusive Beacon tier with a smaller
    // budget than Spark. Its concrete limits still need to be defined in
    // lib/tier-limits.js (TIER_PRICING) before Apex can be provisioned.
  },
  // Beacon Spark / Beam / Lighthouse remain available as standalone upgrades —
  // see lib/tier-limits.js. They supersede Apex for clients who outgrow Lite.
};
...
const BUNDLES = {
  foundation: {
    name: 'Foundation',
    tagline: 'Entry — get online with SEO + the tools to capture leads',
    build: 'starter',                    // $799 one-time
    ladder: 'orbit',                     // $59/mo (includes Launch hosting)
    add_ons: [],                         // none
    setup_total: 799,
    recurring_total: 59,
    pitch: 'For the business getting online for the first time. Site + automated SEO + booking + AI chat + auto lead reply.',
  },
  momentum: {
