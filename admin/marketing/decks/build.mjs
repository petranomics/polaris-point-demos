      ...
      <div class="col-2" style="align-items: start;">
        ...
        <div class="card" style="padding: 0; overflow: hidden;">
          ...
          <div style="background: #fafafa; padding: 10px 20px; font-size: 9px; color: #999; border-top: 1px solid #eee; display: flex; justify-content: space-between;">
            <span>Generated by Polaris Point Analytics</span>
            <span>May 2026</span>
          </div>
        </div>
      </div>
  ...
  // 8. Pricing + CTA
  {
    ...
    content: `
      ...
      <div class="cta-block">
        ...
        <a class="btn" href="https://analytics.polarispoint.io">Get started</a>
      </div>
    `,
  },
];
...
writeFileSync(resolve(here, 'armadillo.html'), deck({
  deckName: 'Polaris Point Analytics',
  fileName: 'armadillo.html',
  title: 'Polaris Point Analytics — Pitch Deck',
...
const whitelabelSlides = [
  // 1. Title
  {
    ...
    content: `
      ...
      <div class="platform-row" style="margin-top: 18px;">
        ...
        <span class="platform-chip"><span class="dot" style="background: #5BA3CF;"></span>Polaris Point analytics</span>
      </div>
    `,
  },
  ...
  // 3. The solution overview
  {
    ...
    eyebrow: 'The solution',
    content: `
      <p class="lead">A bundled platform that runs your entire agency under <strong>your custom domain</strong>. Sub-sites for every agent. Beacon as your content engine with a shared knowledge library and per-agent sub-accounts. Polaris Point for social analytics across every account. All white-labeled, all centralized.</p>
      <div class="stack" style="margin-top: 32px;">
        <div class="layer accent">
          <div class="lname">Your custom domain</div>
          <div class="ldesc">Everything below served from yourdomain.com. No Polaris Point, no Beacon, no Polaris Point branding visible to your clients.</div>
        </div>
        <div class="layer">
        ...
        <div class="layer">
          <div class="lname">Polaris Point analytics</div>
    ...
    content: `
      ...
      <div class="col-3" style="margin-top: 28px;">
        ...
        <div class="card">
          ...
          <p>Search across every site, every Beacon doc, every Polaris Point report from one search bar. AI surfaces what's relevant.</p>
        </div>
        <div class="card">
        ...
        <div>
          <div class="card card-accent">
            ...
            <ol style="padding-left: 22px; font-size: 14px; color: var(--text); line-height: 1.8;">
              ...
              <li>Beacon schedules the publish, tracks results in Polaris Point Analytics</li>
            </ol>
  ...
  // 7. Polaris Point Analytics
  {
    title: 'Polaris Point: social analytics, every agent',
      ...
      <div class="col-2" style="margin-top: 28px;">
        ...
        <div class="card">
          ...
          <ul class="fancy" style="font-size: 14px;">
            ...
            <li>Polaris Point branding (analytics on your terms)</li>
      ...
      <div class="col-2" style="margin-top: 28px;">
        ...
        <div>
          ...
          <ul class="fancy" style="font-size: 14px;">
            ...
            <li>Team-wide Polaris Point dashboard, manager sees every agent</li>
  ...
  // 10. Roadmap status
  {
    ...
    content: `
      ...
      <div class="col-3" style="margin-top: 28px;">
        ...
        <div class="card card-accent">
          <h3>Q4 2026</h3>
          <p>Polaris Point team rollup · Auto media kits per agent · Manager reports · Cross-product AI search</p>
        </div>
      </div>
  ...
  <main class="index">
    ...
    <a class="deck-card" href="white-label.html">
      ...
      <div>
        ...
        <p>Bundled offering pitch · 11 slides · Sub-sites + Centralized AI admin + Beacon + Polaris Point, all under one custom domain. Real-estate brokerage use case.</p>
      </div>
    </a>
  </main>
</body>
