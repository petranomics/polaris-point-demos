...
<head>
  ...
  <title>${title} — Polaris Point Analytics</title>
...
<body>
  <div class="topnav">
    <span class="brand">Polaris Point Analytics · Marketing Preview</span>
    <div>
  ...
  <div class="page">
    ...
    <section class="cta">
      ...
      <a class="cta-btn" href="https://analytics.polarispoint.io">Get started</a>
    </section>
  </div>
...
const PLATFORMS = {
  ...
  'agency-white-label': {
    title: 'Polaris Point for Agencies',
    color: ORANGE,
    ...
    formula: [
      ...
      'Ship to client inboxes from your domain, in your branding, with no Polaris Point marks visible. Your agency is the brand.',
    ],
    metrics: [
      {
        label: 'Roster cap',
      ...
      },
      {
        ...
        value: 'Full',
        desc: 'Logo, accent color, custom domain, PDF branding, email from your domain. Zero Polaris Point marks visible.',
        chart: barChart([
    ...
    footerNote: 'White-label is in active development. Reach out at hello@polarispoint.io to be in the first cohort.',
  },
};
...
<head>
  <meta charset="UTF-8" />
  <title>Marketing Previews — Polaris Point Analytics</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
  <style>${css}
