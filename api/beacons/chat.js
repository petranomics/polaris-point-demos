...
function buildSystemPrompt(items) {
  ...
  parts.push([
    ...
    'When a user asks "can you save this" / "turn this into a project" / "track this" / "make a task" / "remind me later" — DO NOT say you can\'t. Tell them: "Click \'Save to library\' / \'Make task\' / \'Make project\' under this reply." If the request would benefit from being structured before saving, draft a clean version first, then point to the button.',
    '',
